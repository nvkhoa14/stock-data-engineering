...
def transform_to_database_3():
    ...
    companies_json = read_latest_file_in_directory(data_path / "raw" / "companies")
    ...
    path = data_path / "processed" / "transformed_to_database_companies" / f"process_companies_{date}.json"
