...
def transform_to_database_1():
    ...
    companies = read_latest_file_in_directory(data_path / "raw" / "companies")
    markets = read_latest_file_in_directory(data_path / "raw" / "markets")
    ...
    regions_path = data_path / "processed" / "transformed_to_database_regions" / f"process_regions_{date}.json"
    ...
    industries_path = data_path / "processed" / "transformed_to_database_industries" / f"process_industries_{date}.json"
    ...
    sicindustries_path = data_path / "processed" / "transformed_to_database_sicindustries" / f"process_sicindustries_{date}.json"
