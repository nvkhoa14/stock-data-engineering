...
def load_json_to_db_1():
    ...
    insert_data_from_json(
        get_latest_file_in_directory(
            data_path / "processed" / "transformed_to_database_regions", 
            '.json'
        ),
        'regions',
    ...
    insert_data_from_json(
        get_latest_file_in_directory(
            data_path / "processed" / "transformed_to_database_industries", 
            '.json'
        ),
        'industries',
    ...
    insert_data_from_json(
        get_latest_file_in_directory(
            data_path / "processed" / "transformed_to_database_sicindustries", 
            '.json'
        ),
        'sicindustries',
